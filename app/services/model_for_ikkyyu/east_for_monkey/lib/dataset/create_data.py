...
def create_data(raw_data_dir, train_save_dir, val_save_dir, ratio=0.9):
    """
    创建训练数据集和验证数据集
...
if __name__ == '__main__':
    ...
    raw_data_dir = '/share/zzh/raw_data/'

    train_dir = '/root/east_data/train_data'

    val_dir = '/root/east_data/val_data'
