...
tf.app.flags.DEFINE_boolean('USE_CROP', False,
                            'Number of model clones to deploy.')
tf.app.flags.DEFINE_string('loss_type', 'ssd',
                           'loss type is one of "ssd", "focal", "my"')
...
tf.app.flags.DEFINE_string(
    'checkpoint_path', '/workspace/OCR/models/s3d/model.ckpt-88690',
...
#     'vgg_16/AddFpnLayer, vgg_16/AddFcnLayer, vgg_16/new_vgg',
...
# =========================================================================== #
tf.app.flags.DEFINE_string(
    'data_format', 'NHWC', 'data formate')
tf.app.flags.DEFINE_string(
    'model_name', 's3d',
    'The name of the architecture to train.')
tf.app.flags.DEFINE_string(
    'train_dir', '/workspace/OCR/models/train_models_s3d',
...
tf.app.flags.DEFINE_string(
    'dataset_dir', #'/root/MLT_2017',
                   '/workspace/OCR/datasets/TAL_OCR/190424_11875/',
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        image_preprocessing_fn = preprocessing_factory.get_preprocessing(FLAGS.model_name,
                                                                         is_training=True)
        ...
        def clone_fn(batch_queue):
            ...
            with slim.arg_scope(arg_scope):
                _, localisations, logits, end_points = ssd_net.net(b_image, is_training=True)

            # Add loss function.
            ssd_net.losses(logits, localisations, b_gclasses, b_glocalisations, b_gscores,
                           loss_type=FLAGS.loss_type, batch_size=FLAGS.batch_size,
                           negative_ratio=FLAGS.negative_ratio, match_threshold=FLAGS.match_threshold,
                           scope='ssd_losses')
            return end_points
